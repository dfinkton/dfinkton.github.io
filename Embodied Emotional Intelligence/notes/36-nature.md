...
- 90 minutes reduces rumination (Bratman et al., 2015).
- Around 20 minutes, seated or walking, reduces stress (Mygind et al., 2019).
- Ten minutes or more in a garden has been associated with reduced rumination and depressive symptoms (Cox et al., 2017).

## Shinrin-yoku — and this literature is the reason to search outside English-language frames
- Park, B. J., Tsunetsugu, Y., Kasetani, T., Kagawa, T., & Miyazaki, Y. (2010). The physiological effects of shinrin-yoku: Evidence from field experiments in **24 forests across Japan.** *Environmental Health and Preventive Medicine, 15*, 18–26.
- Kotera, Y., Richardson, M., & Sheffield, D. (2020). Effects of shinrin-yoku and nature therapy on mental health: A systematic review and meta-analysis. *International Journal of Mental Health and Addiction.*
- Antonelli, M., Barbieri, G., & Donelli, D. (2019). Effects of forest bathing on cortisol: A systematic review and meta-analysis. *International Journal of Biometeorology, 63*(8), 1117–1134.
- Lee et al. (2017): 21 of 28 forest-bathing studies showed reduced depressive symptoms.
...
## Handle with care
The terpene mechanism — inhaled volatile organic compounds from forest species acting on limbic and inflammatory systems — is a proposed pathway, not an established one. Say so if it appears at all. Li's natural-killer-cell findings are interesting and should not be written as an immunity claim.
